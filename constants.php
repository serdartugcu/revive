...
function setupConstants()
{
    ...
    define('MAX_FINANCE_CPV',	 3);
    define('MAX_FINANCE_CPA',    4);
    define('MAX_FINANCE_MT',     5); // Monthly Tennancy
    define('MAX_FINANCE_RS',     6); // % Revenue split     (zone-only)
    define('MAX_FINANCE_BV',     7); // % Basket value      (zone-only)
    define('MAX_FINANCE_AI',     8); // Amount per item     (zone-only)
    define('MAX_FINANCE_ANYVAR', 9); // % of any variable   (zone-only)
    define('MAX_FINANCE_VARSUM', 10); // % of a variable sum (zone-only)
