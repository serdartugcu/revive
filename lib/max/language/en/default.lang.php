...
// Network
$GLOBALS['strNetwork'] = "Network";
$GLOBALS['strNetworks'] = "Networks";
$GLOBALS['strAddNetwork'] = "Add new network";
$GLOBALS['strNetworkProperties'] = "Network Properties";
$GLOBALS['strNetworkHistory'] = "Network History";
$GLOBALS['strNoNetworks'] = "There are currently no networks defined. To create a website, <a href='network-edit.php'>add a new network</a> first.";
$GLOBALS['strConfirmDeleteNetwork'] = "Do you really want to delete this network?";
$GLOBALS['strConfirmDeleteNetworks'] = "Do you really want to delete the selected networks?";
$GLOBALS['strInactiveNetworksHidden'] = "inactive network(s) hidden";
$GLOBALS['strShowParentNetworks'] = "Show parent networks";
$GLOBALS['strHideParentNetworks'] = "Hide parent networks";

// Network (properties)
$GLOBALS['strNetwork'] = "Network";
$GLOBALS['strNetworkURL'] = "Network URL";
$GLOBALS['strRevenueShare'] = "Revenue Share";
...
$GLOBALS['strNetworkHasBeenAdded'] = "Network <a href='%s'>%s</a> has been added, <a href='%s'>add a website</a>";
$GLOBALS['strNetworkHasBeenUpdated'] = "Network <a href='%s'>%s</a> has been updated";
$GLOBALS['strNetworkHasBeenDeleted'] = "Network <b>%s</b> has been deleted";
$GLOBALS['strNetworksHaveBeenDeleted'] = "All selected network have been deleted";
