...
function _buildNavigation($accountType)
{
    ...
    switch ($accountType) {
        ...
        case OA_ACCOUNT_MANAGER:
            ...
            $oMenu->addTo("inventory", new OA_Admin_Menu_Section("network-index", 'Networks', "network-index.php", false, "inventory", null, 1, false, 'g_website'));
            $oMenu->addTo("network-index", new OA_Admin_Menu_Section("network-edit_new", 'AddNetwork', "network-edit.php", true, "inventory/networkAndWebsites/addNetwork"));
            $oMenu->addTo("network-index", new OA_Admin_Menu_Section("network-edit", 'NetworkProperties', "network-edit.php?networkid={networkid}", false, "inventory/networkAndWebsites/editNetwork"));
